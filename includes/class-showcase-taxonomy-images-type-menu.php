 ...
 * 
 */
if (!class_exists('Showcase_Taxonomy_Images_Type_Menu')) {

    class Showcase_Taxonomy_Images_Type_Menu {
        ...
        public function init() {
            // Image actions
            add_action('type_menu_add_form_fields', array($this, 'add_type_menu_image'), 10, 2);
            add_action('created_type_menu', array($this, 'save_type_menu_image'), 10, 2);
            add_action('type_menu_edit_form_fields', array($this, 'update_type_menu_image'), 10, 2);
            add_action('edited_type_menu', array($this, 'updated_type_menu_image'), 10, 2);
            add_action('admin_enqueue_scripts', array($this, 'load_media'));
            add_action('admin_footer', array($this, 'add_script'));
        }

        public function load_media() {
            if (!isset($_GET['taxonomy']) || $_GET['taxonomy'] != 'type_menu') {
                return;
            }
            wp_enqueue_media();
        }
         ...
         * @since 1.0.0
         */
        public function add_type_menu_image($taxonomy) {
            ?>
         ...
         * @since 1.0.0
         */
        public function save_type_menu_image($term_id, $tt_id) {
         ...
         * @since 1.0.0
         */
        public function update_type_menu_image($term, $taxonomy) {
            ?>
         ...
         * @since 1.0.0
         */
        public function updated_type_menu_image($term_id, $tt_id) {
            if (isset($_POST['showcase-taxonomy-image-id']) && '' !== $_POST['showcase-taxonomy-image-id']) {
